...
- **License Note:** While Pokémon Showdown itself is MIT licensed, the licensing for its sprites can be less clear cut due to community contribution. For educational purposes these have been used for educational purposes locally and should be consdered depending on how this project is used. The primary benefit is access to high-quality, familiar sprites without needing to host them ourselves.
